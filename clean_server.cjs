...
const badBlockStart = "    const distPath = path.join(process.cwd(), 'dist');\n    app.use(express.static(distPath));\n    app.get('*', (req, res) => {\n      res.sendFile(path.join(distPath, 'index.html'));\n    });\n  }";

code = code.substring(0, code.indexOf(badBlockStart) + badBlockStart.length);
