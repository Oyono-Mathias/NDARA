  ...
  return (
    <div className="h-screen flex flex-col overflow-hidden bg-[#0B0F19] text-[#F8FAFC] font-sans antialiased">
      ...
      <div className="flex flex-col lg:flex-row flex-1 overflow-hidden">
        {/* LEFT: Edit Form */}
        <div
          className={`${mobileTab === "preview" ? "hidden lg:block" : "block"} w-full lg:w-[420px] flex-shrink-0 bg-[#111827] border-r border-[#334155] overflow-y-auto`}
        >
          <div className="p-4 space-y-5">
            ...
            <div className="text-center">
              ...
              <button className="mt-2 text-xs text-emerald-400 hover:underline block w-full">
                Changer la photo
              </button>
            </div>
            ...
            <div>
              ...
              <p className="text-[10px] text-gray-500 mt-1">
                Apparaît sous votre nom sur votre page publique
              </p>
            </div>
            ...
            <div>
              ...
              <div className="flex items-center justify-between mt-1.5">
                ...
                <p
                  className={`text-[10px] ${bio.length > 500 ? "text-red-400" : "text-gray-500"}`}
                >
                  {bio.length} / 500
                </p>
              </div>
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2 mb-2">
                {tags.map((tag) => (
                  <span
                    key={tag}
                    className="px-2.5 py-1 bg-emerald-500/10 text-emerald-400 text-xs rounded-lg flex items-center gap-1.5 border border-emerald-500/20"
                  >
                    {tag}{" "}
                    <button
              ...
              <div className="space-y-3">
                ...
                <div className="flex items-center gap-3">
                  <div className="w-8 h-8 rounded-lg bg-gray-700/10 flex items-center justify-center flex-shrink-0">
                    <span className="w-4 h-4 text-white font-bold text-[10px] text-center mb-1">
                      Tik
                      <br />
                      Tok
                    </span>
            ...
            <div>
              ...
              <select
                ...
                className="w-full bg-[#1E293B] border border-[#334155] rounded-xl px-4 py-2.5 text-sm text-white focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 transition-all"
              >
        ...
        {/* RIGHT: Live Preview */}
        <div
          className={`${mobileTab === "edit" ? "hidden lg:block" : "block"} flex-1 bg-[#0B0F19] overflow-y-auto p-4 lg:p-8`}
        >
          <div className="max-w-2xl mx-auto">
            <div className="flex items-center justify-between mb-4 mt-8 lg:mt-0">
              ...
              <div className="flex items-center gap-1.5">
                <button
                  ...
                  className={`p-2 rounded-lg transition-all ${previewDevice === "desktop" ? "bg-[#1E293B] text-emerald-400 border border-emerald-500/30" : "text-gray-400 hover:bg-[#1E293B]"}`}
                >
                  <svg
                    className="w-4 h-4"
                    fill="none"
                ...
                <button
                  ...
                  className={`p-2 rounded-lg transition-all ${previewDevice === "mobile" ? "bg-[#1E293B] text-emerald-400 border border-emerald-500/30" : "text-gray-400 hover:bg-[#1E293B]"}`}
                >
                  <svg
                    className="w-4 h-4"
                    fill="none"
            ...
            <div
              className={`transition-all duration-300 bg-[#111827] border border-[#334155] rounded-2xl overflow-hidden shadow-2xl ${previewDevice === "mobile" ? "max-w-[375px] mx-auto" : "w-full"}`}
            >
              ...
              <div className="px-4 sm:px-6 -mt-10 sm:-mt-12 relative z-10">
                <div className="flex flex-col sm:flex-row sm:items-end gap-4">
                  ...
                  <div className="flex-1 pb-1">
                    ...
                    <p
                      className={`text-sm font-medium ${title ? "text-emerald-400" : "text-gray-500"}`}
                    >
              ...
              <div className="px-4 sm:px-6 py-5 border-b border-[#334155]">
                ...
                <p
                  className={`text-sm leading-relaxed whitespace-pre-line ${bio ? "text-gray-300" : "text-gray-600 italic"}`}
                >
                ...
                <div className="flex flex-wrap gap-2">
                  {tags.length > 0 ? (
                    tags.map((tag) => (
                      <span
                        key={tag}
                        className="px-3 py-1.5 bg-emerald-500/10 text-emerald-400 text-xs rounded-lg border border-emerald-500/20 font-medium"
                      >
                        {tag}
                      </span>
                    ))
                ...
                <div className="flex items-center gap-3 flex-wrap">
                  {socials.website && (
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="w-8 h-8 rounded-full bg-blue-500/10 text-blue-400 hover:bg-blue-500/20 flex items-center justify-center transition-all hover:scale-110"
                    >
                  ...
                  {socials.twitter && (
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="w-8 h-8 rounded-full bg-gray-500/10 text-gray-400 hover:bg-gray-500/20 flex items-center justify-center transition-all hover:scale-110"
                    >
                  ...
                  {socials.linkedin && (
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="w-8 h-8 rounded-full bg-blue-600/10 text-blue-500 hover:bg-blue-600/20 flex items-center justify-center transition-all hover:scale-110"
                    >
                  ...
                  {socials.youtube && (
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="w-8 h-8 rounded-full bg-red-500/10 text-red-500 hover:bg-red-500/20 flex items-center justify-center transition-all hover:scale-110"
                    >
                  ...
                  {socials.instagram && (
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="w-8 h-8 rounded-full bg-pink-500/10 text-pink-500 hover:bg-pink-500/20 flex items-center justify-center transition-all hover:scale-110"
                    >
                  ...
                  {socials.tiktok && (
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="w-8 h-8 rounded-full bg-gray-700/10 text-white hover:bg-gray-700/20 flex items-center justify-center transition-all hover:scale-110"
                    >
      ...
      {toast && (
        <div
          className={`fixed top-20 left-1/2 -translate-x-1/2 z-50 flex items-center gap-2 px-4 py-3 rounded-xl shadow-2xl border bg-[#1E293B] ${
            toast.type === "success"
