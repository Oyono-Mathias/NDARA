  ...
  return (
    <div className="p-6 bg-[#1e293b] border border-white/5 rounded-[2rem] text-white shadow-xl mt-6">
      ...
      <p className="text-sm font-medium text-slate-400 mb-8 italic">
        Consultez et vérifiez les certificats délivrés à vos apprenants.
      </p>
          ...
          <table className="w-full text-left border-collapse">
            <thead>
              <tr className="bg-white/5">
                <th className="p-4 text-[10px] font-bold uppercase tracking-widest text-slate-400 border-b border-white/5">
                  Apprenant
                </th>
                <th className="p-4 text-[10px] font-bold uppercase tracking-widest text-slate-400 border-b border-white/5">
                  Formation
                ...
                <th className="p-4 text-[10px] font-bold uppercase tracking-widest text-slate-400 border-b border-white/5 text-center">
                  ID
                </th>
              </tr>
            </thead>
            <tbody>
              {certificates.map((cert) => (
                <tr
                  key={cert.id}
                  className="hover:bg-white/5 transition border-b border-white/5 last:border-0 group cursor-pointer"
                >
                  ...
                  <td className="p-4 text-slate-400 text-xs font-mono">
                    {cert.issuedAt?.toDate().toLocaleDateString("fr-FR")}
                  </td>
                  <td className="p-4 text-center">
                    <span className="font-mono text-[10px] bg-slate-800 text-slate-400 px-2 py-1 rounded-md">
