...
export function AdminNavigation({ isSidebarOpen, onClose }: { isSidebarOpen?: boolean, onClose?: () => void }) {
        ...
        <div className="p-6 shrink-0">
          ...
          <div className="flex items-center gap-4 p-4 rounded-[1.25rem] bg-slate-800/40 border border-slate-700/50">
            ...
            <div>
              ...
              <p className="text-[10px] font-bold text-slate-400 tracking-widest uppercase">SUPER ADMIN</p>
            </div>
          </div>
        </div>
