...
// Add UI below the lesson content
const qnaUiCode = `
                {/* Q&A Section */}
                <div className="bg-[#0B0F19] border border-white/5 rounded-3xl p-6 md:p-8 mt-8">
